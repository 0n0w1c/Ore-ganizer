...
local rmd_kr_mining_drill_mk2_displayer       =
{
...
local rmd_kr_mining_drill_mk2_entity          = table.deepcopy(data.raw["mining-drill"][TO_COPY])
rmd_kr_mining_drill_mk2_entity.name           = NAME
rmd_kr_mining_drill_mk2_entity.placeable_by   = { item = NAME, count = 1 }
rmd_kr_mining_drill_mk2_entity.minable        = { mining_time = 0.5, result = NAME }
rmd_kr_mining_drill_mk2_entity.localised_name = { "", { "item-name." .. NAME } }
rmd_kr_mining_drill_mk2_entity.icons          =
{
    {
        icon = STONE_ICON
    },
...
local rmd_kr_mining_drill_mk2_item            = table.deepcopy(data.raw["item"][TO_COPY])
rmd_kr_mining_drill_mk2_item.name             = NAME
rmd_kr_mining_drill_mk2_item.place_result     = NAME .. "-displayer"
rmd_kr_mining_drill_mk2_item.flags            = { "primary-place-result" }
rmd_kr_mining_drill_mk2_item.localised_name   = { "", { "item-name." .. NAME } }
rmd_kr_mining_drill_mk2_item.icons            =
{
    {
        icon = STONE_ICON
    },
...
local rmd_kr_mining_drill_mk2_recipe          = table.deepcopy(data.raw["recipe"][TO_COPY])
rmd_kr_mining_drill_mk2_recipe.name           = NAME
rmd_kr_mining_drill_mk2_recipe.results        = { { type = "item", name = NAME, amount = 1 } }

if mods["space-age"] then
    rmd_kr_mining_drill_mk2_displayer.surface_conditions = { { min = 0.1, property = "gravity" } }
    rmd_kr_mining_drill_mk2_entity.surface_conditions = { { min = 0.1, property = "gravity" } }
end

data.extend
({
    rmd_kr_mining_drill_mk2_displayer,
    rmd_kr_mining_drill_mk2_entity,
    rmd_kr_mining_drill_mk2_item,
    rmd_kr_mining_drill_mk2_recipe
})
